...
+------------+-------------+------------------------------------------+
| LineString | LI          | A sequence of points with linear         |
|            | NESTRING(x1 | interpolation between points (e.g., a    |
|            | y1,x2       | road)                                    |
|            | y2,...)     |                                          |
+------------+-------------+------------------------------------------+
| Polygon    | POLYGON((x1 | A polygon (e.g., a boundary) which has a |
|            | y1,x2       | single exterior boundary and zero or     |
|            | y2,...),    | more interior boundaries ( i.e., holes)  |
|            | (x1 y1,x2   |                                          |
|            | y2,...))    |                                          |
+------------+-------------+------------------------------------------+
...
> ❓**Skill builder** Create the three tables for the example and insert
...
the area of one grid unit is 1406 km[^spatial-1] (526 square miles).
...
> ❓**Skill builder** Modify the example database design to include:
>
