...
![](Figures/Chapter 9/query-by-example.png)
...
![](Figures/Chapter 9/shadowed-rows.png)
...
![](Figures/Chapter 9/shadowed-columns.png)
...
a manipulation language (relational algebra). A **fully relational database** 
system provides complete support for each of these
...
12. Use relational algebra with the given data model to solve the
    ...
    g. List the names of donors whose last name is Watson and who live in
    Athens, GA.