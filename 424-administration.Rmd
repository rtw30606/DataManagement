...
gaining full value from data, a key strategic asset.[^1] In 2003,
...
[^1]: This section is based on Lee, Y., Madnick, S., Wang, R., Forea,
...
[^3]: For more on information architecture, see Smith, H. A., Watson, R.
...
a wide range of systems. The Transaction Processing Council (TPC)[^4] is
