...
Architecture**[^1] is a proposed general solution to the speed and cost
problem.

[^1]: Marz, N., & Warren, J. (2012). *Big Data*: Manning Publications.
...
Hadoop, an Apache project,[^2] supports distributed processing of large
...
[^2]: [[http://hadoop.apache.org]{.ul}](http://hadoop.apache.org)

A market analysis projects that the Hadoop market is growing at 58% per
year.[^3] It also asserts that, "Hadoop is the only cost-sensible and
...
[^3]: [[https://www.marketanalysis.com/?p=279]{.ul}](https://www.marketanalysis.com/?p=279)
...
Spark is an Apache project[^4] for cluster computing that was initiated
...
[^4]: [[https://spark.apache.org]{.ul}](https://spark.apache.org)
...
case, we will use the sparklyr,[^5] an R interface to Spark. This
...
[^5]: [[http://spark.rstudio.com]{.ul}](http://spark.rstudio.com)

Before starting with sparklyr, you need to check that you have latest
version of Java on your machine.[^6] Use RStudio to install sparklyr.
For developing and testing on your computer, install a local version of
Spark.

[^6]: [[https://www.java.com/en/download/help/version_manual.xml]{.ul}](https://www.java.com/en/download/help/version_manual.xml)
...
York's Central Park[^7] and we want to determine how often each
particular temperature occurred. R

[^7]: [[http://www.erh.noaa.gov/okx/climate/records/monthannualtemp.html]{.ul}](http://www.erh.noaa.gov/okx/climate/records/monthannualtemp.html)
...
systems. The IEEE Standard for Floating-Point Arithmetic (IEEE 754)[^8]
...
[^8]: [[https://en.wikipedia.org/wiki/IEEE_floating_point]{.ul}](https://en.wikipedia.org/wiki/IEEE_floating_point)
...
> ❓*Skill builder* A file[^9] of electricity costs for a major city
> contains a timestamp and cost separated by a comma. Compute the
> minimum, mean, and maximum costs.

[^9]: [[[http://www.richardtwatson.com/data/electricityprices.csv]{.ul}](http://www.richardtwatson.com/data/electricityprices.csv)](http://people.terry.uga.edu/rwatson/data/electricityprices2010_14.csv)
...
1.  Write Spark code for the following situations.
    ...
    e.  Read the national GDP file,[^10] which records GDP in millions,
        and count how many countries have a GDP greater than or less
        than 10,000 million.

[^10]: [[[http://www.richardtwatson.com/data/GDP.csv]{.ul}](http://www.richardtwatson.com/data/GDP.csv)](http://people.terry.uga.edu/rwatson/data/GDP.csv)
