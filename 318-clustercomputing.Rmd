...
[\^clustercomputing-2] :
[[http://hadoop.apache.org]{.ul}](http://hadoop.apache.org)
...
[\^clustercomputing-3] :
[[https://www.marketanalysis.com/?p=279]{.ul}](https://www.marketanalysis.com/?p=279)
...
*Splitting of a file across a HDFS cluster.*
...
[\^clustercomputing-4] :
[[https://spark.apache.org]{.ul}](https://spark.apache.org)
...
[\^clustercomputing-5] :
[[http://spark.rstudio.com]{.ul}](http://spark.rstudio.com)
...
[\^clustercomputing-6] :
[[https://www.java.com/en/download/help/version_manual.xml]{.ul}](https://www.java.com/en/download/help/version_manual.xml)
...
[\^clustercomputing-7] :
[[http://www.erh.noaa.gov/okx/climate/records/monthannualtemp.html]{.ul}](http://www.erh.noaa.gov/okx/climate/records/monthannualtemp.html)
...
[\^clustercomputing-8] :
[[https://en.wikipedia.org/wiki/IEEE_floating_point]{.ul}](https://en.wikipedia.org/wiki/IEEE_floating_point)

> ❓*Skill builder* Redo the tabulation example with temperatures in
> Celsius.
...
[\^clustercomputing-9] :
[\^[http://www.richardtwatson.com/data/electricityprices.csv]{.underline}\^](<http://people.terry.uga.edu/rwatson/data/electricityprices2010_14.csv>)
...
[\^clustercomputing-10] :
[[http://www.richardtwatson.com/data/GDP.csv]{.ul}](http://people.terry.uga.edu/rwatson/data/GDP.csv)
