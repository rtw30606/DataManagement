...
library(ggplot2)
library(readr)
url <- 'http://www.richardtwatson.com/data/carbon.csv'
...
ggplot(t,aes(C)) + geom_histogram(fill='skyblue') + xlab('Celsius')
```
...
t <- read_csv("~/Dropbox/0Documents/R/GoogleAPIkey.txt")
