...
A grammar has been designed by Wilkinson[^1] for creating graphics to
...
[^1]: Wilkinson, L. (2005). \*The grammar of graphics\* (2nd ed.). New
    York: Springer.
...
ways to reveal clearly the information in large data sets. Vega[^2] is a
...
1.  Given the following data on the world's cargo carrying capacity in
    millions of dead weight tons (dwt)[^4] for the given years, graph
...
[^4]: Dead weight tonnage is a measure of how much weight, in tonnes, a
...
10. Use the 'Import Dataset' feature of RStudio to read
    ...
    which contains details of electricity prices for a major city.[^5]
...
11. Read the table
    ...
    chart[^6] for a choice of colors.
...
[^5]: Note these prices have been transformed from the original values,
    but are still representative of the changes over time.

[^6]: <http://www.w3schools.com/cssref/css_colornames.asp>
