...
| registered subsidiaries, legal entities, in 21 countries, and it was |
| party to more than 900,000 derivatives contracts upon its collapse.  |
| Key stakeholders, such as financial regulators and Lehman's          |
| creditors, were unable to assess their exposure. Furthermore, others |
| were unable to assess the possible ripple on them of the effects of  |
| the collapse because of the transitive nature of many investments    |
| (i.e., A owes B, B owes C, and C owes D).                            |
|                                                                      |
...
|            | DE CIMAL(p,q)            | A packed decimal number of p digits total length; q decimal spaces to the right of the decimal point may be specified |
