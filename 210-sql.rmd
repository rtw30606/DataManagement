...
rule---*the value of a foreign key must be equal to a value of the primary key*
---means that each component of the foreign key must be
...
![](Figures/Chapter 10/data types.png)
...
![](Figures/Chapter 10/accounting.png)
...
> ❓*Skill builder* Why is the primary key of `stock_log` not the same as that of stock?
