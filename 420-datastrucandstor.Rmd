...
Every quarter, The Expeditioner's IS group measures the quality of its
...
Over USD 20 billion is spent annually on magnetic storage devices.[^datastrucandstor-1] A
...
[^datastrucandstor-1]: [[[http://www.gartner.com/it/page.jsp?id=2149415]{.ul}](http://www.terry.uga.edu/people/rwatson/)](http://www.gartner.com/it/page.jsp?id=2149415%5D%7B.underline%7D%5D(http://www.terry.uga.edu/people/rwatson/))
...
as little as twice as costly by 2021.[^datastrucandstor-2] SSD is rapidly becoming the
standard for laptops.

[^datastrucandstor-2]: [https://www.theregister.co.uk/2017/05/22/ssd\\\_price\\\_premium\\\_over\\\_disk\\\_falling/](https://www.theregister.co.uk/2017/05/22/ssd_price_premium_over_disk_falling/)
...
used in SSDs.[^datastrucandstor-3] The introduction of tablets, such as the iPad, and
smartphones is exacerbating this problem.

[^datastrucandstor-3]: <http://www.pcworld.com/businesscenter/article/217883/seagate_solidstate_disks_are_doomed_at_least_for_now.html>
...
+----------+---------+----+-------+------------+--------+----------+
| Device   | Access  | Vo | Volat | Cost per   | Relia  | Legal    |
|          | speed   | lu | ility | megabyte   | bility | standing |
|          |         | me |       |            |        |          |
+:=========+:========+:===+:======+:===========+:=======+:=========+
| Solid    | \*\*\*  | \* | \     | \*         | \*\*\* | \*       |
| state    |         |    | \     |            |        |          |
...
| architecture         |                                               |
+----------------------+-----------------------------------------------+
| Digital versatile    | Redundant arrays of inexpensive or            |
| disc (DVD)           | independent drives (RAID)                     |
+----------------------+-----------------------------------------------+
...
16. According to Wikipedia, Apple has more than 28 million songs in the
    iTunes store.[^datastrucandstor-4] What storage technology might be a good choice for
    this library?

[^datastrucandstor-4]: <http://en.wikipedia.org/wiki/ITunes_Store>
