...
devices.[^datastrucandstor-1] A significant proportion of many units IS
...
as little as twice as costly by 2021.[^datastrucandstor-2] SSD is
...
used in SSDs.[^datastrucandstor-3] The introduction of tablets, such as
...
+--------+--------+--------+--------+--------+--------+--------+
| Device | Access | Vo lu  | Volat  | Cost   | Relia  | Legal  |
|        | speed  | me     | ility  | per    | bility | st     |
|        |        |        |        | me     |        | anding |
|        |        |        |        | gabyte |        |        |
+:=======+:=======+:=======+:=======+:=======+:=======+:=======+
| Solid  | \*\*\* | \*     | \      | \*     | \*\*\* | \*     |
...
16. According to Wikipedia, Apple has more than 28 million songs in the
    iTunes store.[^datastrucandstor-4] What storage technology might be
