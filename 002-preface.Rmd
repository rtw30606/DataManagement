...
topical areas such as data analytics. The third section, Advanced Data Management, which also covers spatial and temporal data, XML, and organizational intelligence, and graph databases
...
site](https://www.richardtwatson.com/open/) that provides
...
-   the answers to the skill builder exercises found in each chapter
-   an extensive set of exercises using the ClassicModels database
-   additional exercises.

## Changes for this seventh edition {.unnumbered}

I've shortened the sixth edition by deleting material that was no longer relevant because of changes in technology and business practices. For instance, I remove the discussion of Map-Reduce, which has been outmoded by software that hides the complexity of  parallel processing  I cut *The Expeditioner*, short introductory case used for some chapters because it was not critical and had become dated. I deleted the CD case study. CDs are obsolete and the case was not longer a meaningful example. Very few people seem to use  this case. I updated costs and facts that had changed over the last few years (e.g., cost per megabyte of storage). The result is a shorter text with minimal reduction in the core material required to master data management and introduce data analytics.
