...
|     | ***Problem*** \| \*\*\*                                                                                                                                                                                         | Solution\*\*\*                                                                                                                                               |
|:----|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 1   | City names are not \| To unique. There is an \| uni Athens in Greece and \| spe the U.S. has an Athens \| adm in Georgia, Alabama, \| cou Ohio, Pennsylvania, \| sig Tennessee, and Texas. \| bet \| UNI \| UNI | identify a city quely, you need to cify its inistrative unit and ntry. Add a plus n to the crow's feet ween CITY and ADMIN T and between ADMIN T and NATION. |
...
> ❓**Skill builder** Write SQL to determine which administrative units have two capitals
> and which have a shared capital.
...
![](Figures/Chapter%207/marriage-1.png)
...
![](Figures/Chapter%207/marriage-2.png)
...
![](Figures/Chapter%207/marriage-3.png)
...
![](Figures/Chapter%207/marriage-4.png)
...
![](Figures/Chapter%207/marriage-5.png)
...
> ❓**Skill builder** The International Commission for Border Resolution Disputes requires 
> a database to record details of which countries have common borders. 
> Design the database. Incidentally, which country borders the most other countries?
...
> ❓**Skill builder** Horse racing is a popular sport in some parts of the world. A horse  
...
> horse can have many jockeys. Of course, there is only ever one
> jockey riding a horse at a particular time. Courses vary in their 
> features, such as the length of the course and the type of surface
> (e.g., dirt or grass). Design a database to keep track of the 
...
![](Figures/Chapter%207/region-city.png)
...
![](Figures/Chapter%207/animal.png)
...
![](Figures/Chapter%207/generalizationanimal.png)
...
![](Figures/Chapter%207/art%20collection%20revised.png)
...
![](Figures/Chapter%206/recursive-1-and-1.png)
...
+-------+-------+-------+-------+-------+-------+-------+-------+
| Brand | Pr    | Ove   | S     | Tap   | FM\   | CD\   | E ase |
| and   | ice   | rall\ | ound\ | ing\  | t     | ha n  |       |
| model |       | score | q u   | qua   | uning | dling | of    |
|       |       |       | ality | lity  |       |       | use   |
+=======+=======+=======+=======+=======+=======+=======+=======+
| Phi   | 140   | 62    | Very  | Good  | Very  | Exc e | F air |
| llips |       |       | good  |       | good  | llent |       |
| SC-   |       |       |       |       |       |       |       |
| AK103 |       |       |       |       |       |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| Pana  | 215   | 55    | Good  | Good  | Very  | Very  | G ood |
| sonic |       |       |       |       | good  | good  |       |
| MC-50 |       |       |       |       |       |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| Rio   | 165   | 38    | Good  | Good  | Fair  | Very  | P oor |
| G300  |       |       |       |       |       | good  |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
