...
+------------+------------+------------------------------------------+
| 1,1        | Man dat    | There is exactly one instance of the     |
|            | ory        | entity relative to the other entity.     |
+------------+------------+------------------------------------------+
...
+=============================+======================+
| Recognizable and            | Identifier           |
| rememberable                | exhaustion         |
|                             |                      |
...
+-----+-----+-----+-----+-----+-----+-----+-----+
| B   | Pr  | Ove | S o | Tap | FM\ | CD\ | E   |
| r   | ice | r   | u   | i   | t u | ha  | ase |
| and |     | a   | nd\ | ng\ | n   | n d |     |
| and |     | ll\ | q u | qua | ing | l   | of  |
| m   |     | s   | a   | l   |     | ing | use |
| o   |     | c   | l   | ity |     |     |     |
| del |     | ore | ity |     |     |     |     |
+=====+=====+=====+=====+=====+=====+=====+=====+
| Phi | 140 | 62  | V   | G   | V   | Exc | F   |
| l   |     |     | ery | ood | ery | e l | air |
| l   |     |     | g   |     | g   | l   |     |
| ips |     |     | ood |     | ood | ent |     |
| SC- |     |     |     |     |     |     |     |
| A   |     |     |     |     |     |     |     |
...
| -50 |     |     |     |     |     |     |     |
+-----+-----+-----+-----+-----+-----+-----+-----+
| Rio | 165 | 38  | G   | G   | F   | V   | P   |
| G   |     |     | ood | ood | air | ery | oor |
| 300 |     |     |     |     |     | g   |     |
|     |     |     |     |     |     | ood |     |
+-----+-----+-----+-----+-----+-----+-----+-----+
