...
| *Skill Builder*                                                      |
|                                                                      |
| Write SQL to determine which administrative units have two capitals  |
...
| *Skill builder*                                                      |
|                                                                      |
| The International Commission for Border Resolution Disputes requires |
| a database to record details of which countries have common borders. |
| Design the database. Incidentally, which country borders the most    |
| other countries?                                                     |
+----------------------------------------------------------------------+
