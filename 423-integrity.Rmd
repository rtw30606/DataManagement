...
implies three goals:[^1]

[^1]: To the author's knowledge, Gordon C. Everest was the first to
...
statistics on the length of the disruption.[^2]

[^2]: Source: Lewis Jr, W., Watson, R. T., & Pickren, A. (2003). An
...
and possess desired features*.[^3] The preceding definition implicitly
...
[^3]: Redman, T. C. (2001). *Data quality : the field guide*. Boston:
    Digital Press.
...
day,[^4] Atlanta's Hartsfield Airport becomes congested when bad
...
results of the following set of queries.[^5]

[^5]: Adapted from Helman, P. (1994). The science of database
