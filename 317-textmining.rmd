...
stem.letters <- tm_map(stem.letters,stemCompletion,
...
```{r eval = T, message = FALSE, fig.cap = 'Probability density plot of word frequency'}
library(ggplot2)
...
```{r eval = T, message = FALSE, fig.cap = 'A word cloud'}
library(wordcloud)
...
```{r eval = T, message = FALSE, fig.cap = 'Dendrogram for Buffett letters from 1998-2012'}
# Cluster analysis
...
```{r eval = T, message = FALSE, fig.cap = 'Inverse document frequency (corpus has 15 documents)'}
