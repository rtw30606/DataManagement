...
we can certainly observe that "ambiguity-in, ambiguity-out" is a truism.
...
reach different conclusions as to its meaning.
...
annual letters for 1998-2012 to the [shareholders of Berkshire Hathaway](http://www.berkshirehathaway.com/letters/letters.html) for 1998-2012. The original letters, available in html
or pdf, were converted to [separate text files](http://www.terry.uga.edu/people/rwatson/) using [Abbyy Fine Reader](https://pdf.abbyy.com).
...
code, we use the [SMART](http://jmlr.csail.mit.edu/papers/volume5/lewis04a/a11-smart-stop-list/english.stop) list of English stop words.
...
specified. Stemming can take a while to process.
...
The generated graphic shows that about 5,000 terms occur in only one
...
[OpenNLP](http://opennlp.apache.org) is an Apache Java-based machine learning based
...
1.  Take the recent annual reports for [UPS](http://www.investors.ups.com/phoenix.zhtml?c=62900&p=irol-reportsannua) and convert
    them to text using an online service, [such as](http://www.fileformat.info/convert/doc/pdf2txt.htm).
