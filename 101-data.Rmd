...
|           | system    |                                              |
+-----------+-----------+----------------------------------------------+
| MIS       | M         | Convert data from a TPS into information for |
|           | anagement | planning, controlling, and managing an       |
|           | in        | organization                                 |
|           | ormation  |                                              |
|           | system    |                                              |
+-----------+-----------+----------------------------------------------+
...
+-----------+-----------+----------------------------------------------+
| BI        | Business  | Gather, store, and analyze data to improve   |
|           | int       | decision making                              |
|           | elligence |                                              |
+-----------+-----------+----------------------------------------------+
| OLAP      | Online    | Provide a multidimensional view of data      |
|           | a         |                                              |
|           | nalytical |                                              |
|           | p         |                                              |
|           | rocessing |                                              |
+-----------+-----------+----------------------------------------------+
|           | Data      | Use of statistical analysis and artificial   |
|           | mining    | intelligence techniques to identify hidden   |
