...
management. Today's organizations are data-driven, and decisions are increasingly based on insights arising from data analytics.
...
systems are covered in detail in the chapter on *Organizational Intelligence*). The purpose of each of
...
business call it *learning the ropes*. New employees spend a great
...
such as the [Australian Broadcasting Corporation](https://www.abc.net.au) has to store to
...
online retailers. *Fourth*, some organizations specialize in selling images
and maintain extensive libraries of clip art and photographs (e.g., [Getty Images](https://www.gettyimages.com)).
...
News organizations, such as [National Public Radio](https://www.npr.org) (NPR) in the U.S., provide audio
...
firm's representative. The [Royal Hong Kong Jockey Club](https://www.hkjc.com/home/english/index.aspx), which covers
...
visit to [Rivian's Web site](https://rivian.com), you can view video clips of the latest
models in action.
...
to the organization. Some of these models are now so detailed, they are a *digital twin* of a product or organization and support extensive exploration of possible product or business scenarios.
...
DL/I product, was the predominant technology for managing data. It was
  replaced by the **relational DBMS**, a concept first discussed by
...
as a graph resulted in **graph database technology**. Towards the end of the 20th century, **XML** was
...
distributed files system, such as **Hadoop** and **Blockchain**, have emerged as alternative
models for data management. Other recent data management systems include
**NoSQL databases** (Not Only SQL). While these are beyond the scope of an
...
widely used data management system. In 2022, the relational database market generated over USD50 billion in revenue.[^data-2] As mentioned, Section 2 is devotedto the development of the necessary skills for designing and using a relational database.

[^data-2]: Abadi, D. et al., (2022). The Seattle report on database research. *Communications of the ACM*, 65(8), 72-79.
...
Watson, R. T. (2020). [*Capital, Systems and Objects: The Foundation and Future of Organizations*](https://link.springer.com/book/10.1007/978-981-15-9418-2). Singapore: Springer
