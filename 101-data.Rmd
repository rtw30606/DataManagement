...
+------------+------------+-----------------------------------------+
|            | Type of in | System's purpose                        |
|            | formation  |                                         |
|            | system     |                                         |
+============+:===========+:========================================+
| TPS        | Tr         | Collect and store data from routine     |
|            | ansaction  | transactions                            |
|            | p          |                                         |
|            | rocessing  |                                         |
|            | system     |                                         |
+------------+------------+-----------------------------------------+
| MIS        | M          | Convert data from a TPS into            |
|            | anagement  | information for planning, controlling,  |
|            | in         | and managing an organization            |
|            | formation  |                                         |
|            | system     |                                         |
+------------+------------+-----------------------------------------+
| DSS        | Decision   | Support managerial decision making by   |
|            | support    | providing models for processing and     |
|            | system     | analyzing data                          |
+------------+------------+-----------------------------------------+
| BI         | Business   | Gather, store, and analyze data to      |
|            | int        | improve decision making                 |
|            | elligence  |                                         |
+------------+------------+-----------------------------------------+
| OLAP       | Online a   | Provide a multidimensional view of data |
|            | nalytical  |                                         |
|            | p          |                                         |
|            | rocessing  |                                         |
+------------+------------+-----------------------------------------+
|            | Data       | Use of statistical analysis and         |
|            | mining     | artificial intelligence techniques to   |
|            |            | identify hidden relationships in data   |
+------------+------------+-----------------------------------------+
|            | Machine    | Using software to make decisions or     |
|            | learning   | recommendations traditionally made by   |
|            |            | humans.                                 |
+------------+------------+-----------------------------------------+
...
|                | for reports                                      |
+----------------+--------------------------------------------------+
| Lack of        | Data management systems do not reflect the       |
| reality        | complexity of the real world                     |
+----------------+--------------------------------------------------+
