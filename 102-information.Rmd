...
power of information organizations.[^information-1] he need to create a
...
|     | information   | mid-1990s     | al            | private       |
|     | work to the   |               |               | networks      |
|     | employee      |               | Client/server |               |
+-----+---------------+---------------+---------------+---------------+
| 3   | Take          | Mid-1990s --- | B             | Public        |
|     | information   | present       | rowser/server | networks\     |
...
+-------+---+---------------------------------------------------------+
| G     | 2 | Identified non-expert source---opinions, feelings, and  |
| ypsum |   | ideas                                                   |
+-------+---+---------------------------------------------------------+
| Ca    | 3 | Identified expert source---predictions, speculations,   |
| lcite |   | forecasts, and estimates                                |
+-------+---+---------------------------------------------------------+
| Flu   | 4 | Unsworn testimony---explanations, justifications,       |
| orite |   | assessments, and interpretations                        |
+-------+---+---------------------------------------------------------+
| Ap    | 5 | Sworn testimony---explanations, justifications,         |
| atite |   | assessments, and interpretations                        |
+-------+---+---------------------------------------------------------+
| Ortho | 6 | Budgets, formal plans                                   |
| clase |   |                                                         |
+-------+---+---------------------------------------------------------+
| Q     | 7 | News reports, non-financial data, industry statistics,  |
| uartz |   | and surveys                                             |
+-------+---+---------------------------------------------------------+
| Topaz | 8 | Unaudited financial statements, and government          |
|       |   | statistics                                              |
+-------+---+---------------------------------------------------------+
| Cor   | 9 | Audited financial statements                            |
| undum |   |                                                         |
+-------+---+---------------------------------------------------------+
| Di    | 1 | Stock exchange and commodity market data                |
| amond | 0 |                                                         |
+-------+---+---------------------------------------------------------+
...
| Richest |       |              |                     | Leanest     |
+:========+=======+==============+=====================+:============+
| Face-   | Tele  | Personal     | Impersonal written  | Numeric     |
| to-face | phone | documents    | documents           | documents   |
+---------+-------+--------------+---------------------+-------------+
...
| service. Thus, some firms use information, and thus customer         |
| service, as a key differentiating factor, while others might compete |
| on price. Compare the electronics component of Web sites Amazon and  |
