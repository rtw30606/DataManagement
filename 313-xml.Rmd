...
edition is stored in XML format.[^1]

[^1]: Cowlishaw, M. F. (1987). Lexx---a programmable structured editor.
...
combined to create Open Financial Exchange (OFX),[^2] a language for the
...
[^3]: You should use an XML editor for creating XML files. I have not
...
[^4]: In this chapter, numbers in {} refer to line numbers in the
    corresponding XML code.

[^5]: A namespace is a collection of valid names of attributes, types,
...
> ❓**Skill builder**
>
> 1.  Use the Firefox browser[^6] to access this book's Web site, link
...
[^6]: Overall, Firefox seems to do the best job of displaying xml files.
...
A second approach is to build a special-purpose XML database. Tamino[^7]
is an example of such an approach.

[^7]: www.softwareag.com/Corporate/products/wm/tamino/default.asp
...
A set of user defined functions (UDF)[^8] has been developed to convert
...
[^8]: The lib\\mysqludf\\xql library is housed at
...
5.  Using the portion of ClassicModels that has been converted to
    XML,[^9] answer the following questions using XPath.
...
[^9]: <http://www.richardtwatson.com/xml/customerpayments.xml>
