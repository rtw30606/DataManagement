...
to execute the sample code. A good option is Eclipse,[^1] a widely used
open source IDE.

[^1]: Install [Eclipse IDE for Java EE Developers]{.underline}.
...
for different types of art, paintings, and sculptures in this case.[^2]

[^2]: The code for creating the database is online at
...
A comma-separated values (CSV) file[^3] is a common form of text file
...
[^5]: <http://richardtwatson.com/dm6e/Reader/java.html>
...
input.[^6] A map scale must be numeric with a minimum of 1000 and
...
[^6]: This is a feature of HTML5 and is not supported by older browsers.
...
code can be downloaded from the book's Web site.[^7]

[^7]: <http://richardtwatson.com/dm6e/Reader/java.html>
