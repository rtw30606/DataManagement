...
The following exercises are based on the NorthWinds graph database, which you can create on your compter by running the supplied [code](https://www.richardtwatson.com/open/Reader/northwind.cypher). 
