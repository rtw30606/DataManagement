...
the openCypher Implementation Group.[^graph-1] Cypher is used in open source
...
based on openCypher and other GQLs.[^graph-2]
...
-   Download Neo4j Desktop[^graph-4] and follow the installation and launch
    guide to create a project and open your browser.
...
> ❓**Skill builder** List those shares where the value of the holding
> exceeds one million.
...
> ❓**Skill builder** Report by nation the total value of dividends.
...
> ❓**Skill builder** Report all red items that have not been sold.
...
[^graph-6]: Needham, M., & Hodler, A. E. (2019). *Graph Algorithms: Practical
...
Problem showcases: [[gist.neo4j.org/]{.ul}](http://gist.neo4j.org/) and
[[neo4j.com/use-cases/]{.ul}](http://neo4j.com/use-cases/)

The following exercises are based on the NorthWinds graph database,
which you can create on your desktop by running the supplied code.[^graph-7]
...
![](Figures/Chapter%2012/graph-NorthWinds)
