...
the openCypher Implementation Group.[^1] Cypher is used in open source
...
based on openCypher and other GQLs.[^2]
...
-   Watch the video titled *Neo4j in Two Minutes;*[^3]

-   Download Neo4j Desktop[^4] and follow the installation and launch
    guide to create a project and open your browser.

[^3]: <https://neo4j.com/neo4j-graph-database/>
...
[^5]: <https://s3.amazonaws.com/artifacts.opencypher.org/openCypher9.pdf>
...
[^6]: Needham, M., & Hodler, A. E. (2019). *Graph Algorithms: Practical
...
which you can create on your desktop by running the supplied code.[^7]
The graph model for NorthWinds follows the questions.

[^7]: <https://www.richardtwatson.com/dm6e/reader/northwind.cypher>
