...
> inspirational.*
>
> Paloma Picasso, designer, 2013[^1]

[^1]: <http://articles.latimes.com/2013/apr/18/news/la-paloma-picasso-discusses-new-olive-leaf-collection-for-tiffany-co-20130418>
...
exchange symbol of AAPL. The getQuote function[^2] of the
...
[^2]: ^getQuote\ returns\ a\ dataframe,\ containing\ eight\ values\ :Trade\ Time,\ Last,\ Change,\ %\ Change,\ Open,\ High,\ Low,\ Volume.\ For\ example,\ getQuote('AAPL')\$\`%\ Change\`\ returns\ the\ percentage\ change\ in\ price\ since\ the\ daily\ opening\ price.^
