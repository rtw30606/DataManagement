...
|                                                                    |
| It is not uncommon to find that a dataset you would like to use is |
| in electronic format, but not in a format that matches your need.  |
| In most cases, you can use a word processor, spreadsheet, or text  |
| editor to reformat the data. In the case of the data in the        |
| previous table, here is a recipe for reformatting the data.        |
|                                                                    |
