...
however, that data modeling is easier to master than normalization.
...
Chen's core concepts spawned many species of data modeling. We briefly
review, later in this chapter, Chen's E-R approach.
...
> ❓ *Skill builder*
>
> You have been given a spreadsheet that contains
...
relationships. The revised data model after the introduction of the rule is:
...
we consider one of the most widely known data modeling methods, the the E-R model developed by Chen. There is no standard for the E-R model, and it has
