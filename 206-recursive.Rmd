...
> ❓*Skill builder* 
>
> A consulting company has assigned each of its
...
data for Nancy and her boss are in the same row. Thus, think of this
...
following table illustrating the result of the self-join.
...
data in the same row, we repeat the self-join with a different WHERE
...
> details of all the players and the pairs of players.
